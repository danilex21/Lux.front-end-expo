            ...
            >
              ...
              <View style={styles.cardContent}>
                ...
                <View style={styles.cardInfoRow}>
                  <Text style={styles.cardScore}>⭐ {anime.rating.toFixed(1)}</Text>
          ...
          {selectedAnime && (
            <View>
              ...
              <View style={{ alignItems: 'center', padding: 24 }}>
                ...
                <Text style={{ color: '#FFD700', fontWeight: 'bold', marginBottom: 4 }}>⭐ {selectedAnime.rating.toFixed(1)}</Text>
          ...
          {editingAnime && (
            <View>
              ...
              <View style={{ alignItems: 'center', padding: 24 }}>
                ...
                <TextInput
                  label="Nota (0-10)"
                  value={editingAnime.rating.toString()}
                  onChangeText={(text) => {
                    const num = parseFloat(text);
                    if (!isNaN(num) && num >= 0 && num <= 10) {
                      setEditingAnime({ ...editingAnime, rating: num });
                    }
                  }}
